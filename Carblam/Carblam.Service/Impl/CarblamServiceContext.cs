...
{
    class CarblamServiceContext : IDisposable, ICarblamServiceContext
    {
        private const string _sessionCookieName = "_mlsSessionId";

        private readonly DisposableList _disposables = new DisposableList();

        public CarblamServiceConfiguration Configuration { get; }

        public string DbConnectionString { get; }
        public ICarblamSessionsManager SessionsManager { get; }
        public ISecureRandom SecureRandom { get; }

        public DateTime UtcNow { get { return DateTime.UtcNow; } }

        public CarblamServiceContext(CarblamServiceConfiguration cfg)
        {
            ...
            this.SessionsManager = new CarblamSessionsManager(cfg.SessionTimeout);
...
" + text + @"
        ...
        public ICarblamRequestContext OpenWebRequestContext()
        {
            return new CarblamRequestContext(this, this.ResolveSession());
        }

        private ICarblamSessionContext ResolveSession()
        {
            ICarblamSessionContext session;
            Guid sessionId;
        ...
        public ICarblamDbContext OpenDb()
        {
            ...
            return new CarblamDbContext(ctx);
        }
